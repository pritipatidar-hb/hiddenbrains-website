...
import { IndustryItem } from "@/lib/web-app-data";

export const WebIndustrySlider = ({ industries }: { industries: IndustryItem[] }) => {
    ...
    return (
        <div className="relative group max-w-7xl mx-auto mt-8">
            <div
                ...
                {industries.map((industry, index) => (
                    ...
                    >
                        ...
                        <div className="p-6 flex-grow flex flex-col bg-white border-x border-b border-gray-100/50">
                            <h4 className="text-[20px] font-bold text-[#14133b] mb-3">{industry.name}</h4>
                            <p className="text-[#6a7c92] text-[15px] leading-relaxed flex-grow line-clamp-4 hover:line-clamp-none transition-all duration-300">
                                {industry.desc}
                            </p>
                        </div>
                    </div>
            ...
            <button
                onClick={() => scroll("left")}
                className={`absolute -left-4 lg:-left-6 xl:-left-12 top-[120px] -translate-y-1/2 w-[46px] h-[46px] rounded-full flex items-center justify-center z-10 transition-all duration-300 shadow-md ${
                    canScrollLeft
            ...
            <button
                ...
                className={`absolute -right-4 lg:-right-6 xl:-right-12 top-[120px] -translate-y-1/2 w-[46px] h-[46px] rounded-full flex items-center justify-center z-10 transition-all duration-300 shadow-md ${
                    canScrollRight

...
export const VehicleTrackingVideo = () => {
    ...
    return (
        <>
            ...
            >
                <Image
                    src="https://cdn-fdiob.nitrocdn.com/HbitivJBuLhibWNKENaXSPjRdSdrKXLC/assets/images/optimized/rev-d591ddb/www.hiddenbrains.co.uk/wp-content/uploads/2023/03/Vehical-Tracking-video-thumbnail.webp"
                    alt="Warehouse-Solutions-HiddenBrains-Video"
                    width={871}
                    height={490}
